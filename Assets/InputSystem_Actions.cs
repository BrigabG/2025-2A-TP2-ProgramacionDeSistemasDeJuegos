...
public partial class @InputSystem_Actions: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        {
            ""name"": ""DebugConsole"",
            ""id"": ""7ea83a83-8525-4c28-9ce3-560ef4c31f5c"",
            ""actions"": [
                {
                    ""name"": ""ToggleConsole"",
                    ""type"": ""Button"",
                    ""id"": ""88aabb98-e62a-4ff6-b4ee-879178212023"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                },
                {
                    ""name"": ""SubmitConsole"",
                    ""type"": ""Button"",
                    ""id"": ""e81a0210-2327-4286-8c52-e35bd4573ef6"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""e3501b8e-b969-434a-9594-e746e3436503"",
                    ""path"": ""<Keyboard>/f1"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""45b5c6f1-511c-456b-ba11-7b7c8499ccb8"",
                    ""path"": ""<Keyboard>/enter"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                    ""action"": ""SubmitConsole"",
                    ""isComposite"": false,
                    ""isPartOfComposite"": false
                }
            ]
    ...
    ""controlSchemes"": [
        ...
        m_DebugConsole_SubmitConsole = m_DebugConsole.FindAction("SubmitConsole", throwIfNotFound: true);
    }
    ...
    ~@InputSystem_Actions()
    {
        ...
        UnityEngine.Debug.Assert(!m_DebugConsole.enabled, "This will cause a leak and performance issues, InputSystem_Actions.DebugConsole.Disable() has not been called.");
    }
    ...
    private readonly InputAction m_DebugConsole_SubmitConsole;
    /// <summary>
    ...
    public struct DebugConsoleActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public DebugConsoleActions(@InputSystem_Actions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "DebugConsole/ToggleConsole".
        /// </summary>
        public InputAction @ToggleConsole => m_Wrapper.m_DebugConsole_ToggleConsole;
        /// <summary>
        /// Provides access to the underlying input action "DebugConsole/SubmitConsole".
        /// </summary>
        public InputAction @SubmitConsole => m_Wrapper.m_DebugConsole_SubmitConsole;
        /// <summary>
        /// Provides access to the underlying input action map instance.
        /// </summary>
        ...
        public void AddCallbacks(IDebugConsoleActions instance)
        {
            ...
            @SubmitConsole.started += instance.OnSubmitConsole;
            @SubmitConsole.performed += instance.OnSubmitConsole;
            @SubmitConsole.canceled += instance.OnSubmitConsole;
        }
    ...
    public interface IDebugConsoleActions
    {
        ...
        /// <summary>
        /// Method invoked when associated input action "SubmitConsole" is either <see cref="UnityEngine.InputSystem.InputAction.started" />, <see cref="UnityEngine.InputSystem.InputAction.performed" /> or <see cref="UnityEngine.InputSystem.InputAction.canceled" />.
        /// </summary>
        /// <seealso cref="UnityEngine.InputSystem.InputAction.started" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.performed" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.canceled" />
        void OnSubmitConsole(InputAction.CallbackContext context);
    }
}
